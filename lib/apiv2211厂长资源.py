...
class Spider(Spider):
    ...
    def _extract_video(self, element):
        ...
        try:
            ...
            # 提取标题
            title_selectors = ['./qyg72.js', './qyg73.js', './qyg74.js', './qyg75.js']
            title = ''
            ...
            # 提取图片
            pic_selectors = ['./qyg76.js', './qyg77.js', './qyg78.js']
            pic = ''
        ...
        try:
            ...
            for i, source_elem in enumerate(source_elements):
                ...
                for ep_link in episode_links:
                    ep_title = ep_link.xpath('./qyg79.js')
                    ep_href = ep_link.xpath('./qyg80.js')
