...
class Spider(Spider):
    ...
    def _extract_video(self, element):
        ...
        try:
            ...
            # 提取标题
            title_selectors = ['./qyg87.js', './qyg88.js', './qyg89.js', './qyg90.js']
            title = ''
            ...
            # 提取图片
            pic_selectors = ['./qyg91.js', './qyg92.js', './qyg93.js']
            pic = ''
        ...
        try:
            ...
            for i, source_elem in enumerate(source_elements):
                ...
                for ep_link in episode_links:
                    ep_title = ep_link.xpath('./qyg94.js')
                    ep_href = ep_link.xpath('./qyg95.js')
